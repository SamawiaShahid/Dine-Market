    ...
    return(
        ...
        <div className="   grid lg:space-x-12 xl:grid-cols-3  lg:grid-cols-3 sm:grid-cols-1 ">
           ...
           <div className="Product2    font-[600] text-[#212121] xl:text-xl lg:text-base -translate-x-5
            transition ease-in-out delay-200 hover:translate-y-1 hover:scale-110 w-[100%] sm:w-[100%] ml-8 lg:-mt-1 xl:mt-0 object-cover self-center">
            <a href="/">
            <Image src="/ladyyyy.jpg"  alt=" " height={100} width={350} className="w-[100%] "></Image></a>
            <p className="lg:mt-5 mt-0">Cameryn Sash Tie Dress</p>
            <p>$545</p>
            </div> 
         <div className="Product3 font-[600] text-[#212121] xl:text-xl lg:text-base
          -translate-x-10 transition ease-in-out delay-200 hover:translate-y-1 hover:scale-110 sm:w-[100%] w-[100%] ml-14 lg:mt-0  object-cover ">
            <a href="/">
